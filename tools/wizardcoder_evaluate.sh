...
do
    ...
    do
        ...
        memorization=$(python3 process_wizardcoder.py --dataset $DATA --model $MODEL --run-id 1 --num-deltas $NUM_DELTAS)
        ...
        memorization=$(python3 process_wizardcoder.py --dataset $DATA --model $MODEL --run-id 2 --num-deltas $NUM_DELTAS)
